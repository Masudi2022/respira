...
export default function RespiraHome() {
  ...
  const titleSize = isMobile ? "2rem" : isTablet ? "3rem" : "4.5rem";
  const subtitleSize = isMobile ? "1rem" : isTablet ? "1.5rem" : "2rem";
  const descriptionSize = isMobile ? "0.9rem" : isTablet ? "1.1rem" : "1.3rem";
  const buttonPadding = isMobile ? "10px 20px" : isTablet ? "16px 40px" : "18px 48px";
  ...
  return (
    ...
    >
      ...
      <Container fluid className="px-lg-5 px-3">
        {isMobile ? (
          /* MOBILE LAYOUT - Compact, no card carousel */
          <Row className="justify-content-center align-items-center min-vh-85">
            <Col xs={12}>
              <div
                style={{
                  maxWidth: "100%",
              ...
              >
                ...
                <div
                  style={{
                    background: `linear-gradient(90deg, ${TEAL_DARK}, ${TEAL_ACCENT})`,
                    color: PRIMARY_WHITE,
                    padding: "8px 20px",
                    borderRadius: "20px",
                    fontSize: "12px",
                    ...
                    boxShadow: `0 4px 15px rgba(47,182,166,0.3)`,
                  }}
                >
                  {currentSlide.tag}
                </div>
