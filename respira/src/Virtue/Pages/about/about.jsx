...
export default function AboutUs() {
  ...
  return (
    <div style={{ 
      ...
      <section style={{ 
        padding: "120px 0",
        background: "linear-gradient(180deg, #ffffff 0%, #f8fcfb 50%, #ffffff 100%)"
      }}>
        <Container>
          <div className="text-center mb-5">
            <div style={{
            ...
            <p style={{ color: "#666", maxWidth: 700, margin: "0 auto 50px", fontSize: "1.1rem" }}>
              Passionate individuals committed to preserving and sharing Zanzibar's heritage
            </p>
          </div>
                  ...
                  <Card.Body style={{ padding: "30px" }}>
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <FaGraduationCap size={18} color={PRIMARY} />
